...
While developing run `npm run serve:build` as this will open the website
...
package is correct by running `npm run build` and then checking the
output.

## Deploy

This step is done automatically: the server will
[periodically pull from the branch],
